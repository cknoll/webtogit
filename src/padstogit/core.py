...
class Core:
    ...
    def __init__(self, testmode=False):
        self.data_dir = appdirs.user_data_dir(appname=APPNAME)
        self.config_dir = appdirs.user_config_dir(appname=APPNAME)
        self.settings = None
        self.repo_dir = None
    ...
    def load_settings(self):
        ...
        self.settings = {
            "repo_parent_path": self.data_dir,
            "repo_name": repo_name,
            "readme_content": "This file was generated by padstogit\n",
            "sources": f"{self.data_dir}/example-data/sources.yml",
        }
